...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                ...
                <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{url('/#team')}}">Produk</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{url('/#team')}}">Pemesanan</a></li>
        ...
        <h2 class="section-heading text-uppercase">Detail Barang</h2>
                          ...
                          <table class="table ">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  {{$co->nama}}
                                  <input type="text" name="id_produk[]" value="{{$co->id_produk}}" class="form-control" hidden="">
                                  <input type="text" name="nama[]" value="{{$co->nama}}" class="form-control" hidden="">
                              </td>
                                <td>Rp. {{number_format($co->harga)}}
                                <input type="text" name="harga[]" value="{{$co->harga}}" class="form-control" hidden=""></td>
                                <td>{{$co->jumlah}}
                                <input type="text" name="jumlah[]" value="{{$co->jumlah}}" class="form-control" hidden=""></td>
                                <td>Rp. {{number_format($co->subtotal)}}
                                <input type="text" name="subtotal[]" value="{{$co->subtotal}}" class="form-control" hidden=""></td>
                              </tr> 
                              @endforeach
                            </tbody>
                          </table>
                            ...
                            <div class="col-md-12 mt-5">
                              <div class="card text-dark">
                                  ...
                                  <div class="card-body">
                                      ...
                                      <input class="form-control" type="text" required name="jalan"></input>
                                    <div class="row">
                                      <div class="col-md-3">
         ...
         <button type="submit" class="btn btn-info mt-3 float-right"><i class="fa fa-lock"></i>Buat Pesanan</button>
        </form>
        </section>

            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#team">Pemesanan</a></li>
                            ...
                            <form action="{{url('keranjang')}}" method="post">
                              ...
                              <div class="form-row">
                                <div class="form-group col-md-5">
                                  <input type="text" class="form-control" id="inputPassword4" name="id_produk" value="{{$produk->id}}" readonly="" hidden="">
                                ...
                                <div class="form-group col-md-3">
                                  <label for="inputPassword4">Nama Seller</label>
                                  <input type="text" class="form-control" id="inputPassword4" name="seller" value="{{$produk->seller->username}}" readonly="">
                                </div>
                              </div>
                              <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                  ...
                                  <input type="number" min="1" max="{{$produk->stok}}" class="form-control" id="jumlah" name="jumlah" required="" autofocus="">
                                </div>
                              </div>
                              <div class="form-row mt-2">
                                <div class="form-group col-md-8">
                                  ...
                                  <textarea id="desk" class="form-control" rows="10" readonly="">{!! nl2br($produk->deskripsi) !!}</textarea>
                                </div>
                              </div>
                        
                        
                        <button type="submit" class="btn btn-info"><i class="fa fa-lock"></i> Beli</button>
                            </form>
                        </div>
                    </div>
                </div>
